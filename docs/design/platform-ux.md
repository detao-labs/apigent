...
| `/repos/[id]` | 仓库详情（独立布局） | `repo-detail.html` | P0 | 已实现（总览 / 导入 / 密钥 / MCP 开关）；endpoints/schemas/context 为独立子路由 |
| `/repos/[id]/endpoints` | 接口列表 + 接口详情 | `repo-endpoints.html` | P0 | 已实现（内嵌分栏接口详情） |
| `/repos/[id]/schemas` | 数据模型 | `data-models.html` | P1 | 已实现 |
...
| `/settings` | 设置（账号 / API 密钥 / 偏好 / 更多） | `account-settings.html` | P0 | 密钥管理与账号已实现；偏好 / 更多占位 |
