...
export { buildCapabilitySnapshot, type ContextStats } from "./aggregate";
export { computeEndpointFingerprint, endpointKey, type FingerprintEndpoint } from "./fingerprint";
